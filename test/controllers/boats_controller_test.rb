...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { container_amount: @boat.container_amount, location: @boat.location, name: @boat.name } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { container_amount: @boat.container_amount, location: @boat.location, name: @boat.name } }
